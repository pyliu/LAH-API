if (Vue) {
    Vue.component("case-sur-mgt", {
        ...
        components: {
            "case-sur-dialog": {
                template: `<div>
                    收件字號：<a title="案件辦理情形 on ${landhb_svr}" :href="'http://${landhb_svr}:9080/LandHB/Dispatcher?REQ=CMC0202&GRP=CAS&MM01=' + json.raw['MM01'] + '&MM02=' + json.raw['MM02'] + '&MM03=' + json.raw['MM03'] + '&RM90='" target="_blank">{{json.收件字號}}</a> </br>
                    收件時間：{{json.收件時間}} <br/>
