...
let initModalUI = () => {
	...
	if ($("#bs_modal_template").length == 0) {
		$("body").append($.parseHTML(`
			<div class="modal fade" id="bs_modal_template" tabindex="-1" role="dialog" aria-labelledby="bs_modal_template" aria-hidden="true" style="z-index:9997">
...
let initAlertUI = () => {
	...
	if ($("#bs_alert_template").length == 0) {
		$("body").append($.parseHTML(`
			<div v-show="seen" id="bs_alert_template" class="alert alert-dismissible alert-fixed shadow" :class="type" role="alert" @mouseover="mouseOver" @mouseout="mouseOut" style="z-index:9998">
