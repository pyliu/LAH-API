...
define('UPLOAD_RESERVE_PDF_DIR', UPLOAD_PDF_DIR.DIRECTORY_SEPARATOR.'adm_reserve_file');
define('UPLOAD_SUR_DESTRUCTION_TRACKING_PDF_DIR', UPLOAD_PDF_DIR.DIRECTORY_SEPARATOR.'sur_destruction_tracking');
...
define('WEB_XAP', System::getInstance()->getWebAPIp() ?? "220.1.34.161");
