...
class RegCaseData {
    ...
    public function getReceptionistTooltipAttr() {
        return empty($this->row["RM96"]) || $this->row["RM96"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM96"]."' data-name='".$this->getIDorName($this->row["RM96"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='收件人員：".$this->row["RM96"]."'";
    }
    ...
    public function getCurrentOperatorTooltipAttr() {
        return empty($this->row["RM30_1"]) || $this->row["RM30_1"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM30_1"]."' data-name='".$this->getIDorName($this->row["RM30_1"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='作業人員：".$this->row["RM30_1"]."'";
    }
    ...
    public function getSecondReviewerTooltipAttr() {
        return empty($this->row["RM47"]) || $this->row["RM47"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM47"]."' data-name='".$this->getIDorName($this->row["RM47"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='複審人員：".$this->row["RM47"]."'";
    }
    ...
    public function getPreRegisterTooltipAttr() {
        return empty($this->row["RM63"]) || $this->row["RM63"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM63"]."' data-name='".$this->getIDorName($this->row["RM63"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='准登人員：".$this->row["RM63"]."'";
    }
    ...
    public function getRegisterTooltipAttr() {
        return empty($this->row["RM55"]) || $this->row["RM55"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM55"]."' data-name='".$this->getIDorName($this->row["RM55"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='登記人員：".$this->row["RM55"]."'";
    }
    ...
    public function getCheckerTooltipAttr() {
        return empty($this->row["RM57"]) || $this->row["RM57"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM57"]."' data-name='".$this->getIDorName($this->row["RM57"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='校對人員：".$this->row["RM57"]."'";
    }
    ...
    public function getCloserTooltipAttr() {
        return empty($this->row["RM59"]) || $this->row["RM59"] == "XXXXXXXX" ? "" : "class='user_tag' @click.stop='xhrQueryUserInfo' data-id='".$this->row["RM59"]."' data-name='".$this->getIDorName($this->row["RM59"])."' data-display-selector='#in_modal_display' data-toggle='tooltip' title='結案人員：".$this->row["RM59"]."'";
    }
}
?>
