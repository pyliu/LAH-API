...
class TdocUserInfo {
    ...
    public function getOnBoardUsers() {
        ...
        Logger::getInstance()->info(__METHOD__.": 取得所內所有在職的使用者。");
    ...
    public function getOffBoardUsers() {
        ...
        Logger::getInstance()->info(__METHOD__.": 取得所內所有離職的使用者。");
    ...
    public function searchByIP($ip) {
        ...
        if(!filter_var($ip, FILTER_VALIDATE_IP)) {
            Logger::getInstance()->error(__METHOD__.": ${ip} 位址格式不正確。");
            return $results;
        }

        Logger::getInstance()->info(__METHOD__.": Search By IP: $ip");
