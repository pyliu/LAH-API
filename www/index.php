...
<body id="html_body">
  ...
  <small id="copyright" class="text-muted my-2 mx-3 fixed-bottom bg-white border rounded"><p id="copyright" class="text-center" style="cursor: pointer"><strong data-placement='bottom' data-toggle="tooltip" title="CLICK for SURPRISE!">&copy; <a href="mailto:pangyu.liu@gmail.com">LIU, PANG-YU</a> ALL RIGHTS RESERVED.</strong></p></small>
